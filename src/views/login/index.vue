  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="username">
        ...
        <el-input v-model="loginForm.username" name="username" type="text" auto-complete="on" placeholder="用户名" clearable/>
      </el-form-item>
      ...
      <el-button plain size="mini" style="float: right" >修改密码</el-button>
      <!--<div class="tips">-->
